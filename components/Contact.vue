          ...
          <b-col class="ContactDetails align-middle">
            ...
            <b-row align-v="center">
              <div class="ImageWidth">
                <b-img
                  v-bind="props"
                  src="~/assets/location_on-24px.svg"
                  alt="Location"
                />
              </div>
...
export default {
  ...
  data() {
    return {
      ...
      detailText:
        'Do you have any questions? Please do not hesitate to contact us directly and our team will come back to you.',
      props: {
        width: 25,
        height: 25,
      },
